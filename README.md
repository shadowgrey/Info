...
# **Visual Odometry using essential matrix decomposition to estimate the path of a vehicle using monocular camera feed below panel shows blue color is actual patha and red color is estimated path**

https://drive.google.com/file/d/1NcNhSP6pHbIWIJunCA3Dfd3T8yepllqC/view?usp=sharing
...
# **Developed a GPU-optimized Retrieval-Augmented Generation (RAG) system for PDF question answering, utilizing advanced LLMs {GoOgLe}(Flan-T5), FAISS for efficient semantic search, and Sentence Transformers for embeddings, enabling scalable and accurate context-based response generation.**

https://github.com/user-attachments/assets/8c31022d-220b-4fac-9947-67bdca466d62
